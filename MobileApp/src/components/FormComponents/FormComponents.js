    ...
    return (
      <View style={styles.container}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Avatar.Icon size={45} icon="comment-question" />
      ...
      <View style={styles.container}>
        ...
        <View style={styles.textInput}>
          <TextInput
            ...
            placeholder={
              this.props.isNumeric ? 'Numerical response' : 'Write something'
            }
          />
        </View>
        <Divider />
    ...
    return (
      <View>
        <View style={styles.uneditableComponent}>
          <Avatar.Icon size={45} icon={this.props.icon} />
          {/* <Text style={styles.title}>{this.props.title} </Text> */}
          <Text style={styles.title}>
            {this.props.values &&
              this.props.values.map((val, i) => {
                return <Text key={i}>{val.toString()} </Text>;
              })}
          </Text>
        </View>
        <Divider />
